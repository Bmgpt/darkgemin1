...
st.caption("""Dark Gemini AI is built from the ground up for multimodality reasoning seamlessly across text, photos, images and codes. The most capable Dark AI.""")
